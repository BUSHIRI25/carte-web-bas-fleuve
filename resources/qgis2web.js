...
map.getView().fit([1383511.462490, -748535.573086, 1703256.189903, -505576.833168], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">carte web bas fleuve</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (39 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'il s\'agit d\'une carte web de bas fleuve';
            }
